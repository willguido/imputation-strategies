...
masked_data1, mask1 = mask_data(data1_scaled, ratio=0.1)
masked_data2, mask2 = mask_data(data2_scaled, ratio=0.1)
masked_data1 = np.nan_to_num(masked_data1, nan=0.0)
masked_data2 = np.nan_to_num(masked_data2, nan=0.0)
np.save("/results01/mask1.npy", mask1)
np.save("/results01/mask2.npy", mask2)

# Save the masked and scaled data
np.save("/results01/data1_scaled.npy", masked_data1)
np.save("/results01/data2_scaled.npy", masked_data2)
print("Masked and scaled data saved")
...
np.save("/results01/integrated_data.npy", integrated_data)
...
np.save("/results01/data1_imputed.npy", data1_imputed)
print("data1_imputed saved")
np.save("/results01/data2_imputed.npy", data2_imputed)
...
plt.legend()
plt.savefig("/results01/UMAP_Imputed_JAMIE.png")
