...
masked_data1, mask1 = mask_data(data1_scaled, ratio=0.7)
masked_data2, mask2 = mask_data(data2_scaled, ratio=0.7)
...
np.save("/results07/data1_scaled.npy", masked_data1)
np.save("/results07/data2_scaled.npy", masked_data2)
np.save("/results07/mask1.npy", mask1)
np.save("/results07/mask2.npy", mask2)
...
np.save("/results07/integrated_data.npy", integrated_data)
...
np.save("/results07/data1_imputed.npy", data1_imputed)
print("data1_imputed saved")
np.save("/results07/data2_imputed.npy", data2_imputed)
...
plt.legend()
plt.savefig("/results07/UMAP_Imputed_JAMIE.png")
