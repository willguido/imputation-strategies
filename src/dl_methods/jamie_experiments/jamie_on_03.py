...
masked_data1, mask1 = mask_data(data1_scaled, ratio=0.3)
masked_data2, mask2 = mask_data(data2_scaled, ratio=0.3)
...
np.save("/results03/data1_scaled.npy", masked_data1)
np.save("/results03/data2_scaled.npy", masked_data2)
np.save("/results03/mask1.npy", mask1)
np.save("/results03/mask2.npy", mask2)
...
np.save("/results03/integrated_data.npy", integrated_data)
...
np.save("/results03/data1_imputed.npy", data1_imputed)
print("data1_imputed saved")
np.save("/results03/data2_imputed.npy", data2_imputed)
...
plt.legend()
plt.savefig("/results03/UMAP_Imputed_JAMIE.png")
